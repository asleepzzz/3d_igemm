...
#include "gridwise_convolution_implicit_gemm_v4r4_nchw_kcyx_nkhw_3d.hpp"
...
template <class T,
          ...
          class InLeftPads,
          class InRightPads>
void device_convolution_implicit_gemm_v4r4_nchw_kcyx_nkhw_3d(InDesc,
                                                          ...
                                                          ck::index_t nrepeat)
{
    ...
    constexpr auto gridwise_conv = GridwiseConvolutionImplicitGemm_v4r4_nchw_kcyx_nkhw_3d<
        GridSize,
        BlockSize,
        T,
        T,
