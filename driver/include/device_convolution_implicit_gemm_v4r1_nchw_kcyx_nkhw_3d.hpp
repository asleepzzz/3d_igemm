...
#include "gridwise_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_3d.hpp"
...
template <typename T,
          ...
          typename LeftPads,
          typename RightPads>
void device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_3d(InDesc,
                                                          ...
                                                          ck::index_t nrepeat)
{
    ...
    constexpr index_t B = (N * Do * Ho * Wo) / (N1 * N2);
    ...
    constexpr auto gridwise_conv =
        GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_3d<
            GridSize,
            BlockSize,
            T,
            T,
