#ifndef CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_3D_HPP
#define CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_3D_HPP
...
struct make_wei_e_k_global_desc_v4r1_3d;

template <>
struct make_wei_e_k_global_desc_v4r1_3d<ConvolutionDirection::Forward>
{
    ...
    __device__ constexpr auto operator()(WeiDesc) const
    {
        ...
        return reorder_tensor_descriptor_given_upper2lower(
            unfold_tensor_descriptor(WeiDesc{}, I1, I4), Sequence<1, 0>{});
    }
};

template <>
struct make_wei_e_k_global_desc_v4r1_3d<ConvolutionDirection::BackwardWeight>
{
    template <typename WeiDesc>
    __device__ constexpr auto operator()(WeiDesc) const
    {
        ...
        constexpr index_t Z = wei_k_c_y_x_global_desc.GetLength(I2);
        constexpr index_t Y = wei_k_c_y_x_global_desc.GetLength(I3);
        constexpr index_t X = wei_k_c_y_x_global_desc.GetLength(I4);

        return transform_tensor_descriptor(
            unfold_tensor_descriptor(wei_k_c_y_x_global_desc, I2, I4),
            make_tuple(Merge<Sequence<C, Z * Y * X>>{}, PassThrough<K>{}),
...
struct GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_3d
{
                        ...
                        Float* const __restrict__ p_out_global) const
    {
        ...
        constexpr index_t Di = in_n_c_hi_wi_global_desc.GetLengths()[2];
        constexpr index_t Hi = in_n_c_hi_wi_global_desc.GetLengths()[3];
        constexpr index_t Wi = in_n_c_hi_wi_global_desc.GetLengths()[4];

        constexpr index_t K  = out_n_k_ho_wo_global_desc.GetLengths()[1];
        constexpr index_t Do = out_n_k_ho_wo_global_desc.GetLengths()[2];
        constexpr index_t Ho = out_n_k_ho_wo_global_desc.GetLengths()[3];
        constexpr index_t Wo = out_n_k_ho_wo_global_desc.GetLengths()[4];

        constexpr index_t Z = wei_k_c_y_x_global_desc.GetLengths()[2];
        constexpr index_t Y = wei_k_c_y_x_global_desc.GetLengths()[3];
        constexpr index_t X = wei_k_c_y_x_global_desc.GetLengths()[4];

        constexpr index_t ConvStrideZ = ConvStrides{}[0];
        constexpr index_t ConvStrideH = ConvStrides{}[1];
        constexpr index_t ConvStrideW = ConvStrides{}[2];

        constexpr index_t ConvDilationZ = ConvDilations{}[0];        
        ...
        constexpr index_t B = N0 * Do * Ho * Wo;

        constexpr index_t E = C * Z * Y * X;
        ...
        constexpr auto in_n_c_hip_wip_global_desc = transform_tensor_descriptor(
            ...
            make_tuple(
                PassThrough<N>{}, PassThrough<C>{}, Pad<Sequence<Di, Hi, Wi>, LeftPads, RightPads>{}),
        ...
        constexpr auto in_n0_n1_n2_c_y_ho_x_wo_global_desc = transform_tensor_descriptor(
            ...
            make_tuple(UnMerge<Sequence<N0, N1, N2>>{},
                       PassThrough<C>{},
                       Embed<Hip, Sequence<Z, Do>, Sequence<ConvDilationZ, ConvStrideZ, 0>>{},
        ...
        constexpr auto in_e_n1_b_n2_global_desc = transform_tensor_descriptor(
            ...
            make_tuple(Merge<Sequence<C, Z, Y, X>>{},
                       PassThrough<N1>{},
        ...
        constexpr auto wei_e_k_global_desc =
            make_wei_e_k_global_desc_v4r1_3d<ConvDirection>{}(wei_k_c_y_x_global_desc);
        ...
        // copy output: register to global memory
        {
            ...
            constexpr auto out_n0_n1_n2_k0_k1_ho_wo_global_desc = transform_tensor_descriptor(
                ...
                make_tuple(UnMerge<Sequence<N0, N1, N2>>{},
                           ...
                           PassThrough<Wo>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{},Sequence<4>{}),
                make_tuple(Sequence<0, 1, 2>{}, Sequence<3, 4>{}, Sequence<5>{}, Sequence<6>{},Sequence<7>{}));
